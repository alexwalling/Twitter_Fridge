...
byte mac[] = { 
  0x90, 0xA2, 0xDA, 0x00, 0xD8, 0x07 };
IPAddress ip(192,168,254,27); //<<< ENTER YOUR IP ADDRESS HERE!!!
...
Twitter twitter("972995690-PwmNDTFXJiRSC9xvpe2KsgHvsGPDICACVouQxfjF"); // replace aaaaaaa with your token
Servo myservo;
Servo drp;
